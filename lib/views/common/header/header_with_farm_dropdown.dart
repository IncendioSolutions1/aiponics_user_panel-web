...
class CustomHeaderWithFarmDropdown extends ConsumerWidget {
  ...
  final double desktopFarmWidth;
  final double desktopFarmHeight;
  final double tabletFarmWidth;
  final double tabletFarmHeight;
  final double mobileFarmWidth;
  final double mobileFarmHeight;
  final String selectedFarm;
  final List<String> farmsList;
  ...
  CustomHeaderWithFarmDropdown({
    ...
    this.desktopFarmWidth = 150,
    this.desktopFarmHeight = 45,
    this.tabletFarmWidth = 150,
    this.tabletFarmHeight = 45,
    this.mobileFarmWidth = 150,
    this.mobileFarmHeight = 47,
  }) : farmsList = farmsList ?? const ['Farm 1', 'Farm 2', 'Farm 3'],
        selectedFarm = selectedFarm ?? (farmsList ?? const ['Farm 1', 'Farm 2', 'Farm 3']).first;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final updateFarmState = ref.read(userInfoProvider.notifier);
    ...
    if(responsive == 'desktop'){
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  farmDropdown(updateFarmState, themeColors, userState, desktopFarmWidth, desktopFarmHeight)
                ],
              ),
            ],
          ),
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  const SizedBox(height: 30),
                  // Dropdown for selecting farm
                  farmDropdown(updateFarmState, themeColors, userState, tabletFarmWidth, tabletFarmHeight)
                ],
              ),
            ],
          ),
      ...
      return Column(
        ...
        children: [
          ...
          const SizedBox(height: 30),
          // Dropdown for selecting farm
          farmDropdown(updateFarmState, themeColors, userState, mobileFarmWidth, mobileFarmHeight),
          const SizedBox(height: 30),
          // Share, print, and export button
  ...
  Widget farmDropdown(UserInfoNotifier updateFarmState, ThemeColors themeColors, UserInfo userState, double width, double height) {
    return SizedBox(
                ...
                child: DropdownSearch<String>(
                  ...
                  items: (filter, infiniteScrollProps) => farmsList, // Provides the list of farms and devices
                  selectedItem: selectedFarm, // Sets the default selected item
                  ...
                  popupProps: PopupProps.menu(
                    ...
                    menuProps: MenuProps(
                      backgroundColor: themeColors.boxColor, // Background color of the dropdown menu
                    ...
                    itemBuilder: (context, item, isSelected, boolAgain) {
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          color: themeColors.boxColor, // Background color based on selection
                          borderRadius:
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            color: item == userState.selectedFarm ? themeColors.borderColor :themeColors.boxHeadingColor, // Text color based on selection
                            fontWeight: item == userState.selectedFarm ? FontWeight.w600 : null,
                          ),
                        ),
                      );
                    },
